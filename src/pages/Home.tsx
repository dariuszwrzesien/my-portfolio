...
const Home = () => {
  return (
    <div className="custom-sidebar-margin-left px-2 sm:px-4 flex gap-4 h-full z-1">
      {/* Hello Section */}
      <section className="flex flex-col justify-center w-full">
        <p className="text-foreground text-sm md:text-lg">Hi all. I am</p>
        ...
        <p className="text-foreground text-xs md:text-md pt-8 md:pt-16">// find my profile on LinkedIn</p>
