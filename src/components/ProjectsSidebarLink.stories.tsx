...
export const HoverStates: Story = {
  ...
  decorators: [
    (Story) => (
      <div className="w-48 p-4 border border-gray-200 rounded">
        <p className="text-sm text-gray-600 mb-2">Hover over the label to see effects:</p>
        <Story />
      </div>
    ),
  ],
...
export const SidebarLinkGroup: Story = {
  render: () => (
    <div className="w-64 p-4 border border-gray-200 rounded">
      ...
      <div className="space-y-4">
        <ProjectsSidebarLink label={ProjectCategory.React} icon={getIcon(ProjectCategory.React)} onChange={fn()} />
        <ProjectsSidebarLink label={ProjectCategory.Vue} icon={getIcon(ProjectCategory.Vue)} onChange={fn()} />
        <ProjectsSidebarLink label={ProjectCategory.Angular} icon={getIcon(ProjectCategory.Angular)} onChange={fn()} />
        <ProjectsSidebarLink label={ProjectCategory.NodeJS} icon={getIcon(ProjectCategory.NodeJS)} onChange={fn()} />
        <ProjectsSidebarLink
  ...
  parameters: {
    docs: {
      description: {
        story: 'Shows multiple sidebar links together as they appear in the actual sidebar.',
      },
    },
  },
};
