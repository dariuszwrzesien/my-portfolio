...
export const ValidationStates: Story = {
  render: () => (
    <div className="space-y-4 w-96 p-5">
      <div>
        <Label className="text-sm font-medium mb-1 block text-green-700">Valid Message ✓</Label>
        <Textarea
      ...
      <div>
        <Label className="text-sm font-medium mb-1 block text-red-700">Invalid Message ✗</Label>
        <Textarea value="" placeholder="This field is required" aria-invalid rows={3} />
        <p className="text-sm text-red-600 mt-1">Message is required</p>
      </div>

      <div>
        <Label className="text-sm font-medium mb-1 block text-yellow-700">Warning ⚠</Label>
        <Textarea
          value="Short msg"
          className="border-yellow-300 focus-visible:border-yellow-500 focus-visible:ring-yellow-500/20"
          rows={3}
        />
        <p className="text-sm text-yellow-600 mt-1">Message seems quite short. Consider adding more detail.</p>
      </div>
    </div>
  ),
  parameters: {
