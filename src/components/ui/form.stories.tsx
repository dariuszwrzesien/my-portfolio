...
export const ComplexForm: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Complex registration form with multiple field types and validation rules.',
      },
    },
  },
};

const ValidationStatesComponent = () => {
  const form = useForm({
    resolver: zodResolver(basicSchema),
    defaultValues: {
      email: 'invalid-email',
...
export const ValidationStates: Story = {
  render: () => <ValidationStatesComponent />,
  parameters: {
    docs: {
      description: {
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                ...
                <FormLabel className="text-sm leading-none">Remember me</FormLabel>
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea placeholder="Please describe your inquiry..." rows={4} {...field} />
                </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>This is a helpful description for the field.</FormDescription>
            </FormItem>
          )}
        />
...
export const FieldStates: Story = {
  render: () => <FieldStatesComponent />,
  parameters: {
    docs: {
      description: {
        story: 'Demonstration of different field states including normal, with description, with error, and disabled.',
      },
    },
  },
};
