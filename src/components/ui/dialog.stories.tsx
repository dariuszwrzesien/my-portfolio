  ...
  render: () => (
    <Dialog>
      ...
      <DialogContent>
        ...
        <DialogFooter>
          <DialogClose asChild>
            <button className="px-4 py-2 text-gray-100 hover:text-gray-400 transition-colors">Cancel</button>
          </DialogClose>
...
const ControlledDialogComponent = () => {
  ...
  return (
    <div className="space-y-4 p-5">
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>This dialog's open state is controlled by external state.</DialogDescription>
          </DialogHeader>
          <div className="py-4">
      ...
      <p className="text-sm text-gray-600">Dialog is currently: {open ? 'Open' : 'Closed'}</p>
    </div>
  );
};
...
export const ControlledDialog: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Controlled dialog with external state management and programmatic control.',
      },
    },
  },
};
    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Fill in the details to add a new contact to your list.</DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          <DialogClose asChild>
            <button className="px-4 py-2 text-gray-600 hover:text-gray-800 transition-colors">Cancel</button>
          </DialogClose>
          <DialogClose asChild>
            <button
              className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>This dialog contains a large amount of content with scrolling.</DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4">
...
export const NoCloseButton: Story = {
  render: () => (
    <Dialog>
      ...
      <DialogContent showCloseButton={false}>
        ...
        <div className="py-4">
          <p>The close button (X) has been hidden. You must use the footer buttons to close.</p>
        </div>
        <DialogFooter>
          <DialogClose asChild>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Dialog with the close button (X) hidden, requiring explicit action.',
      },
    },
  },
};
