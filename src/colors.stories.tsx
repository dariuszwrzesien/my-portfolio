      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 rounded border bg-background">
            ...
            <code className="text-xs text-background">
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-4 rounded border bg-primary-foreground">
            ...
            <code className="text-xs text-white bg-black">
              oklch(0.985 0 0)
            </code>
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 rounded border bg-secondary">
            ...
            <code className="text-xs text-white bg-black">oklch(0.97 0 0)</code>
          ...
          <div className="p-4 rounded border bg-secondary-foreground">
            ...
            <code className="text-xs text-black">oklch(0.205 0 0)</code>
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          <div className="p-4 rounded border bg-orange-50">
            <p className="text-black font-medium">50</p>
            <code className="text-xs text-black">{`bg-orange-50`}</code>
          </div>
          <div className="p-4 rounded border bg-orange-100">
            <p className="text-black font-medium">100</p>
            <code className="text-xs text-black">{`bg-orange-100`}</code>
          </div>
          <div className="p-4 rounded border bg-orange-200">
            <p className="text-black font-medium">200</p>
            <code className="text-xs text-black">{`bg-orange-200`}</code>
          </div>
          <div className="p-4 rounded border bg-orange-300">
            <p className="text-black font-medium">300</p>
            <code className="text-xs text-black">{`bg-orange-300`}</code>
          </div>
          <div className="p-4 rounded border bg-orange-400">
            <p className="text-black font-medium">400</p>
            <code className="text-xs text-black">{`bg-orange-400`}</code>
          </div>
          <div className="p-4 rounded border bg-orange-500">
            <p className="text-black font-medium">500</p>
            <code className="text-xs text-black">{`bg-orange-500`}</code>
          </div>
          <div className="p-4 rounded border bg-orange-600">
            <p className="text-white font-medium">600</p>
            <code className="text-xs text-black">{`bg-orange-600`}</code>
          </div>
          <div className="p-4 rounded border bg-orange-700">
            <p className="text-white font-medium">700</p>
            <code className="text-xs text-black">{`bg-orange-700`}</code>
          </div>
          <div className="p-4 rounded border bg-orange-800">
            <p className="text-white font-medium">800</p>
            <code className="text-xs text-black">{`bg-orange-800`}</code>
          </div>
          <div className="p-4 rounded border bg-orange-900">
            <p className="text-white font-medium">900</p>
            <code className="text-xs text-black">{`bg-orange-900`}</code>
          </div>
          <div className="p-4 rounded border bg-orange-950">
            <p className="text-white font-medium">950</p>
            <code className="text-xs text-black">{`bg-orange-950`}</code>
          </div>
        </div>
      </section>
      {/* Secondary / Teal */}
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          <div className="p-4 rounded border bg-teal-50">
            <p className="text-black font-medium">50</p>
            <code className="text-xs text-black">{`bg-teal-50`}</code>
          </div>
          <div className="p-4 rounded border bg-teal-100">
            <p className="text-black font-medium">100</p>
            <code className="text-xs text-black">{`bg-teal-100`}</code>
          </div>
          <div className="p-4 rounded border bg-teal-200">
            <p className="text-black font-medium">200</p>
            <code className="text-xs text-black">{`bg-teal-200`}</code>
          </div>
          <div className="p-4 rounded border bg-teal-300">
            <p className="text-black font-medium">300</p>
            <code className="text-xs text-black">{`bg-teal-300`}</code>
          </div>
          <div className="p-4 rounded border bg-teal-400">
            <p className="text-black font-medium">400</p>
            <code className="text-xs text-black">{`bg-teal-400`}</code>
          </div>
          <div className="p-4 rounded border bg-teal-500">
            <p className="text-black font-medium">500</p>
            <code className="text-xs text-black">{`bg-teal-500`}</code>
          </div>
          <div className="p-4 rounded border bg-teal-600">
            <p className="text-white font-medium">600</p>
            <code className="text-xs text-black">{`bg-teal-600`}</code>
          </div>
          <div className="p-4 rounded border bg-teal-700">
            <p className="text-white font-medium">700</p>
            <code className="text-xs text-black">{`bg-teal-700`}</code>
          </div>
          <div className="p-4 rounded border bg-teal-800">
            <p className="text-white font-medium">800</p>
            <code className="text-xs text-black">{`bg-teal-800`}</code>
          </div>
          <div className="p-4 rounded border bg-teal-900">
            <p className="text-white font-medium">900</p>
            <code className="text-xs text-black">{`bg-teal-900`}</code>
          </div>
          <div className="p-4 rounded border bg-teal-950">
            <p className="text-white font-medium">950</p>
            <code className="text-xs text-black">{`bg-teal-950`}</code>
          </div>
        </div>
      </section>
      {/* Secondary / Indigo */}
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          <div className="p-4 rounded border bg-indigo-50">
            <p className="text-black font-medium">50</p>
            <code className="text-xs text-black">{`bg-indigo-50`}</code>
          </div>
          <div className="p-4 rounded border bg-indigo-100">
            <p className="text-black font-medium">100</p>
            <code className="text-xs text-black">{`bg-indigo-100`}</code>
          </div>
          <div className="p-4 rounded border bg-indigo-200">
            <p className="text-black font-medium">200</p>
            <code className="text-xs text-black">{`bg-indigo-200`}</code>
          </div>
          <div className="p-4 rounded border bg-indigo-300">
            <p className="text-black font-medium">300</p>
            <code className="text-xs text-black">{`bg-indigo-300`}</code>
          </div>
          <div className="p-4 rounded border bg-indigo-400">
            <p className="text-black font-medium">400</p>
            <code className="text-xs text-black">{`bg-indigo-400`}</code>
          </div>
          <div className="p-4 rounded border bg-indigo-500">
            <p className="text-black font-medium">500</p>
            <code className="text-xs text-black">{`bg-indigo-500`}</code>
          </div>
          <div className="p-4 rounded border bg-indigo-600">
            <p className="text-white font-medium">600</p>
            <code className="text-xs text-black">{`bg-indigo-600`}</code>
          </div>
          <div className="p-4 rounded border bg-indigo-700">
            <p className="text-white font-medium">700</p>
            <code className="text-xs text-black">{`bg-indigo-700`}</code>
          </div>
          <div className="p-4 rounded border bg-indigo-800">
            <p className="text-white font-medium">800</p>
            <code className="text-xs text-black">{`bg-indigo-800`}</code>
          </div>
          <div className="p-4 rounded border bg-indigo-900">
            <p className="text-white font-medium">900</p>
            <code className="text-xs text-black">{`bg-indigo-900`}</code>
          </div>
          <div className="p-4 rounded border bg-indigo-950">
            <p className="text-white font-medium">950</p>
            <code className="text-xs text-black">{`bg-indigo-950`}</code>
          </div>
        </div>
      </section>
      {/* Secondary / Rose */}
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          <div className="p-4 rounded border bg-rose-50">
            <p className="text-black font-medium">50</p>
            <code className="text-xs text-black">{`bg-rose-50`}</code>
          </div>
          <div className="p-4 rounded border bg-rose-100">
            <p className="text-black font-medium">100</p>
            <code className="text-xs text-black">{`bg-rose-100`}</code>
          </div>
          <div className="p-4 rounded border bg-rose-200">
            <p className="text-black font-medium">200</p>
            <code className="text-xs text-black">{`bg-rose-200`}</code>
          </div>
          <div className="p-4 rounded border bg-rose-300">
            <p className="text-black font-medium">300</p>
            <code className="text-xs text-black">{`bg-rose-300`}</code>
          </div>
          <div className="p-4 rounded border bg-rose-400">
            <p className="text-black font-medium">400</p>
            <code className="text-xs text-black">{`bg-rose-400`}</code>
          </div>
          <div className="p-4 rounded border bg-rose-500">
            <p className="text-black font-medium">500</p>
            <code className="text-xs text-black">{`bg-rose-500`}</code>
          </div>
          <div className="p-4 rounded border bg-rose-600">
            <p className="text-white font-medium">600</p>
            <code className="text-xs text-black">{`bg-rose-600`}</code>
          </div>
          <div className="p-4 rounded border bg-rose-700">
            <p className="text-white font-medium">700</p>
            <code className="text-xs text-black">{`bg-rose-700`}</code>
          </div>
          <div className="p-4 rounded border bg-rose-800">
            <p className="text-white font-medium">800</p>
            <code className="text-xs text-black">{`bg-rose-800`}</code>
          </div>
          <div className="p-4 rounded border bg-rose-900">
            <p className="text-white font-medium">900</p>
            <code className="text-xs text-black">{`bg-rose-900`}</code>
          </div>
          <div className="p-4 rounded border bg-rose-950">
            <p className="text-white font-medium">950</p>
            <code className="text-xs text-black">{`bg-rose-950`}</code>
          </div>
        </div>
      </section>
      {/* Accent / Purple */}
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          <div className="p-4 rounded border bg-purple-50">
            <p className="text-black font-medium">50</p>
            <code className="text-xs text-black">{`bg-purple-50`}</code>
          </div>
          <div className="p-4 rounded border bg-purple-100">
            <p className="text-black font-medium">100</p>
            <code className="text-xs text-black">{`bg-purple-100`}</code>
          </div>
          <div className="p-4 rounded border bg-purple-200">
            <p className="text-black font-medium">200</p>
            <code className="text-xs text-black">{`bg-purple-200`}</code>
          </div>
          <div className="p-4 rounded border bg-purple-300">
            <p className="text-black font-medium">300</p>
            <code className="text-xs text-black">{`bg-purple-300`}</code>
          </div>
          <div className="p-4 rounded border bg-purple-400">
            <p className="text-black font-medium">400</p>
            <code className="text-xs text-black">{`bg-purple-400`}</code>
          </div>
          <div className="p-4 rounded border bg-purple-500">
            <p className="text-black font-medium">500</p>
            <code className="text-xs text-black">{`bg-purple-500`}</code>
          </div>
          <div className="p-4 rounded border bg-purple-600">
            <p className="text-white font-medium">600</p>
            <code className="text-xs text-black">{`bg-purple-600`}</code>
          </div>
          <div className="p-4 rounded border bg-purple-700">
            <p className="text-white font-medium">700</p>
            <code className="text-xs text-black">{`bg-purple-700`}</code>
          </div>
          <div className="p-4 rounded border bg-purple-800">
            <p className="text-white font-medium">800</p>
            <code className="text-xs text-black">{`bg-purple-800`}</code>
          </div>
          <div className="p-4 rounded border bg-purple-900">
            <p className="text-white font-medium">900</p>
            <code className="text-xs text-black">{`bg-purple-900`}</code>
          </div>
          <div className="p-4 rounded border bg-purple-950">
            <p className="text-white font-medium">950</p>
            <code className="text-xs text-black">{`bg-purple-950`}</code>
          </div>
        </div>
      </section>
      {/* Neutral color */}
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          <div className="p-4 rounded border bg-neutral-50">
            <p className="text-black font-medium">50</p>
            <code className="text-xs text-black">{`bg-neutral-50`}</code>
          </div>
          <div className="p-4 rounded border bg-neutral-100">
            <p className="text-black font-medium">100</p>
            <code className="text-xs text-black">{`bg-neutral-100`}</code>
          </div>
          <div className="p-4 rounded border bg-neutral-200">
            <p className="text-black font-medium">200</p>
            <code className="text-xs text-black">{`bg-neutral-200`}</code>
          </div>
          <div className="p-4 rounded border bg-neutral-300">
            <p className="text-black font-medium">300</p>
            <code className="text-xs text-black">{`bg-neutral-300`}</code>
          </div>
          <div className="p-4 rounded border bg-neutral-400">
            <p className="text-black font-medium">400</p>
            <code className="text-xs text-black">{`bg-neutral-400`}</code>
          </div>
          <div className="p-4 rounded border bg-neutral-500">
            <p className="text-black font-medium">500</p>
            <code className="text-xs text-black">{`bg-neutral-500`}</code>
          </div>
          <div className="p-4 rounded border bg-neutral-600">
            <p className="text-white font-medium">600</p>
            <code className="text-xs text-black">{`bg-neutral-600`}</code>
          </div>
          <div className="p-4 rounded border bg-neutral-700">
            <p className="text-white font-medium">700</p>
            <code className="text-xs text-black">{`bg-neutral-700`}</code>
          </div>
          <div className="p-4 rounded border bg-neutral-800">
            <p className="text-white font-medium">800</p>
            <code className="text-xs text-black">{`bg-neutral-800`}</code>
          </div>
          <div className="p-4 rounded border bg-neutral-900">
            <p className="text-white font-medium">900</p>
            <code className="text-xs text-black">{`bg-neutral-900`}</code>
          </div>
          <div className="p-4 rounded border bg-neutral-950">
            <p className="text-white font-medium">950</p>
            <code className="text-xs text-black">{`bg-neutral-950`}</code>
          </div>
        </div>
      </section>
      {/* Semantic color */}
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          <div className="p-4 rounded border bg-red-50">
            <p className="text-black font-medium">50</p>
            <code className="text-xs text-black">{`bg-red-50`}</code>
          </div>
          <div className="p-4 rounded border bg-red-100">
            <p className="text-black font-medium">100</p>
            <code className="text-xs text-black">{`bg-red-100`}</code>
          </div>
          <div className="p-4 rounded border bg-red-200">
            <p className="text-black font-medium">200</p>
            <code className="text-xs text-black">{`bg-red-200`}</code>
          </div>
          <div className="p-4 rounded border bg-red-300">
            <p className="text-black font-medium">300</p>
            <code className="text-xs text-black">{`bg-red-300`}</code>
          </div>
          <div className="p-4 rounded border bg-red-400">
            <p className="text-black font-medium">400</p>
            <code className="text-xs text-black">{`bg-red-400`}</code>
          </div>
          <div className="p-4 rounded border bg-red-500">
            <p className="text-black font-medium">500</p>
            <code className="text-xs text-black">{`bg-red-500`}</code>
          </div>
          <div className="p-4 rounded border bg-red-600">
            <p className="text-white font-medium">600</p>
            <code className="text-xs text-black">{`bg-red-600`}</code>
          </div>
          <div className="p-4 rounded border bg-red-700">
            <p className="text-white font-medium">700</p>
            <code className="text-xs text-black">{`bg-red-700`}</code>
          </div>
          <div className="p-4 rounded border bg-red-800">
            <p className="text-white font-medium">800</p>
            <code className="text-xs text-black">{`bg-red-800`}</code>
          </div>
          <div className="p-4 rounded border bg-red-900">
            <p className="text-white font-medium">900</p>
            <code className="text-xs text-black">{`bg-red-900`}</code>
          </div>
          <div className="p-4 rounded border bg-red-950">
            <p className="text-white font-medium">950</p>
            <code className="text-xs text-black">{`bg-red-950`}</code>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          <div className="p-4 rounded border bg-green-50">
            <p className="text-black font-medium">50</p>
            <code className="text-xs text-black">{`bg-green-50`}</code>
          </div>
          <div className="p-4 rounded border bg-green-100">
            <p className="text-black font-medium">100</p>
            <code className="text-xs text-black">{`bg-green-100`}</code>
          </div>
          <div className="p-4 rounded border bg-green-200">
            <p className="text-black font-medium">200</p>
            <code className="text-xs text-black">{`bg-green-200`}</code>
          </div>
          <div className="p-4 rounded border bg-green-300">
            <p className="text-black font-medium">300</p>
            <code className="text-xs text-black">{`bg-green-300`}</code>
          </div>
          <div className="p-4 rounded border bg-green-400">
            <p className="text-black font-medium">400</p>
            <code className="text-xs text-black">{`bg-green-400`}</code>
          </div>
          <div className="p-4 rounded border bg-green-500">
            <p className="text-black font-medium">500</p>
            <code className="text-xs text-black">{`bg-green-500`}</code>
          </div>
          <div className="p-4 rounded border bg-green-600">
            <p className="text-white font-medium">600</p>
            <code className="text-xs text-black">{`bg-green-600`}</code>
          </div>
          <div className="p-4 rounded border bg-green-700">
            <p className="text-white font-medium">700</p>
            <code className="text-xs text-black">{`bg-green-700`}</code>
          </div>
          <div className="p-4 rounded border bg-green-800">
            <p className="text-white font-medium">800</p>
            <code className="text-xs text-black">{`bg-green-800`}</code>
          </div>
          <div className="p-4 rounded border bg-green-900">
            <p className="text-white font-medium">900</p>
            <code className="text-xs text-black">{`bg-green-900`}</code>
          </div>
          <div className="p-4 rounded border bg-green-950">
            <p className="text-white font-medium">950</p>
            <code className="text-xs text-black">{`bg-green-950`}</code>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          <div className="p-4 rounded border bg-yellow-50">
            <p className="text-black font-medium">50</p>
            <code className="text-xs text-black">{`bg-yellow-50`}</code>
          </div>
          <div className="p-4 rounded border bg-yellow-100">
            <p className="text-black font-medium">100</p>
            <code className="text-xs text-black">{`bg-yellow-100`}</code>
          </div>
          <div className="p-4 rounded border bg-yellow-200">
            <p className="text-black font-medium">200</p>
            <code className="text-xs text-black">{`bg-yellow-200`}</code>
          </div>
          <div className="p-4 rounded border bg-yellow-300">
            <p className="text-black font-medium">300</p>
            <code className="text-xs text-black">{`bg-yellow-300`}</code>
          </div>
          <div className="p-4 rounded border bg-yellow-400">
            <p className="text-black font-medium">400</p>
            <code className="text-xs text-black">{`bg-yellow-400`}</code>
          </div>
          <div className="p-4 rounded border bg-yellow-500">
            <p className="text-black font-medium">500</p>
            <code className="text-xs text-black">{`bg-yellow-500`}</code>
          </div>
          <div className="p-4 rounded border bg-yellow-600">
            <p className="text-white font-medium">600</p>
            <code className="text-xs text-black">{`bg-yellow-600`}</code>
          </div>
          <div className="p-4 rounded border bg-yellow-700">
            <p className="text-white font-medium">700</p>
            <code className="text-xs text-black">{`bg-yellow-700`}</code>
          </div>
          <div className="p-4 rounded border bg-yellow-800">
            <p className="text-white font-medium">800</p>
            <code className="text-xs text-black">{`bg-yellow-800`}</code>
          </div>
          <div className="p-4 rounded border bg-yellow-900">
            <p className="text-white font-medium">900</p>
            <code className="text-xs text-black">{`bg-yellow-900`}</code>
          </div>
          <div className="p-4 rounded border bg-yellow-950">
            <p className="text-white font-medium">950</p>
            <code className="text-xs text-black">{`bg-yellow-950`}</code>
          </div>
        </div>
      </section>
    </div>
